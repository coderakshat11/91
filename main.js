...
function down()
{
   ...
   {
	   rover_y = rover_y + 10;
	   console.log("when down arrow is pressed, x = " + " | y = " +rover_y);
	   uploadBackground();
	   uploadrover();
   } 
}
...
function right()
{
   ...
   {
	   rover_x = rover_x + 10;
	   console.log("when right arrow is pressed, x = " + " | y = " +rover_y);
	   uploadBackground();
	   uploadrover();
   } 
}
...
function left()
{
   ...
   {
	   rover_x = rover_x - 10;
	   console.log("when left arrow is pressed, x = " + " | y = " +rover_y);
	   uploadBackground();
	   uploadrover();
   } 
}
